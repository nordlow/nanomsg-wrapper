...
/// Socket option levels - Negative numbers are reserved for transports, positive for socket types.
...
/// websocket NN_WS level socket/cmsg option
/// Note that only NN_WSMG_TYPE_TEXT and NN_WS_MSG_TYPE_BINARY messages are supported fully by this
/// implementation.  Attempting to set other message types is undefined.
...
/**
    ...
    Parameters:
        hint =  opaque value that was passed to transport's bind or connect function.
*/
...
/// Returns:
///     1 is the specified socket type is a valid peer for this socket,
///     or 0 otherwise.
extern(C) int nn_epbase_ispeer (nn_epbase* self, int socktype);
